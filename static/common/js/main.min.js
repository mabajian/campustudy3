...
taskListObj=new TaskListObj();carouselObj=new CarouselObj();calendarObj=new CalendarObj();

$(document).ready(function(){init(); $(".version_B_sessions").click(function(event){
...
$(document).on("onTemplateReady",function(){init();
...
panels=a.children("li"),tabs=$(".tabbed-list-view-nav a"),tabWidth=$(window).width()/5;
