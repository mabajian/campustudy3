...
function initializePage(){
	$(".version_B_sessions").click(funcion(){ woopra.track("version_B_sessions"); });
	$(".version_B_course").click(funcion(){ woopra.track("version_B_course"); });
	$(".version_B_help").click(funcion(){ woopra.track("version_B_help"); });
	$(".version_B_map").click(funcion(){ woopra.track("version_B_map"); });
	$(".version_A_sessions").click(funcion(){});
	$(".version_A_course").click(funcion(){});
	$(".version_A_help").click(funcion(){});
	$(".version_A_map").click(funcion(){});
